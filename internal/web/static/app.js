...
function renderSnapshot(snap) {
  ...
  document.getElementById("pressure").textContent = snap.wireline.steam_pressure_psi.toFixed(0);
  document.getElementById("mw").textContent = snap.wireline.output_mw.toFixed(1);
  document.getElementById("couch-level").textContent = snap.couch.level_percent.toFixed(1);
  document.getElementById("burner").textContent = snap.headbox.burner_phase;
  document.getElementById("o2").textContent = snap.headbox.excess_o2_pct.toFixed(2);
  trendData.push(snap.wireline.steam_pressure_psi);
...
document.getElementById("btn-dewater").addEventListener("click", () => postAction("/dewater/start?holder=hmi"));
document.getElementById("btn-dewater-done").addEventListener("click", () => postAction("/dewater/complete?holder=hmi"));
