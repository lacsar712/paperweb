...
const (
	EvStartDewater     PlantEvent = "start_dewater"
	EvDewaterComplete  PlantEvent = "dewater_complete"
...
func StateLabel(s model.PlantState) string {
	...
	case model.StateColdStandby:
		return "Cold Standby"
	case model.StateDewater:
		return "Wireframe Dewater"
...
func EventLabel(e PlantEvent) string {
	switch e {
	case EvStartDewater:
		return "Start Dewater"
	case EvDewaterComplete:
		return "Dewater Complete"
	case EvIgnite:
		return "Ignite"
