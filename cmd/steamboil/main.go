...
import (
	...
	"github.com/lacsar712/paperweb/internal/web"
	"github.com/lacsar712/paperweb/internal/web/api"
)
...
func main() {
	...
	go func() {
		log.Printf("paperweb listening on %s (unit %s)", cfg.ListenAddr, application.UnitID())
